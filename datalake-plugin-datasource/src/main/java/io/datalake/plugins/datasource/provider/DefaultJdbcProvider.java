...
import io.datalake.plugins.common.constants.DatasourceTypes;
import io.datalake.plugins.datasource.entity.TableDesc;
import io.datalake.plugins.datasource.entity.TableField;
import io.datalake.plugins.common.exception.DataEaseException;
...
public abstract class DefaultJdbcProvider extends Provider {
    ...
    static private final String FILE_PATH = "/opt/datalake/drivers";
    static private final String THIRDPART_PATH = "/opt/datalake/plugins/thirdpart";
    static private final String DEFAULT_PATH = "/opt/datalake/plugins/default";
    static private final String CUSTOM_PATH = "/opt/datalake/custom-drivers/";
